...
"[project]/app/member/protocol/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ProtocolPage() {
    ...
    const { data, mutate } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swr$2f$dist$2f$index$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"])("protocol-full", {
        "ProtocolPage.useSWR": async ()=>{
            ...
            return {
                userId: user.id,
                items: items || [],
                doneToday: new Set((comps || []).map({
                    "ProtocolPage.useSWR": (c)=>c.item_id
                }["ProtocolPage.useSWR"]))
            };
        }
    }["ProtocolPage.useSWR"]);
...
_s(ProtocolPage, "ERdN3rzLUSooPJ5Ro+1HU2PtNoo=", false, function() {
    return [
...
_c = ProtocolPage;
var _c;
__turbopack_context__.k.register(_c, "ProtocolPage");
...
//# sourceMappingURL=app_member_protocol_page_tsx_1-idkkl._.js.map