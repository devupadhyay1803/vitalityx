module.exports = [
"[project]/app/member/messages/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function MessagesPage() {
    ...
    const [peer, setPeer] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const channel = supabase.channel("messages-room").on("postgres_changes", {
            ...
            if (m.sender_id === me && m.receiver_id === peer.id || m.sender_id === peer.id && m.receiver_id === me) {
                setMessages((prev)=>prev.find((x)=>x.id === m.id) ? prev : [
                        ...prev,
                        m
                    ]);
            }
...
//# sourceMappingURL=app_member_messages_page_tsx_14bx0ol._.js.map