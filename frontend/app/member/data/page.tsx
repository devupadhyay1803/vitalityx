...
function BiomarkersTable() {
 ...
 return (
 <div className="overflow-hidden vx-card">
 <table className="vx-table" data-testid="biomarkers-table">
...
function BioAgeTrend() {
 ...
 <p className="mt-2 font-display text-5xl">{latest.biological_age != null && String(latest.biological_age) !== "null" ? `${latest.biological_age} yrs` : "—"}</p>
