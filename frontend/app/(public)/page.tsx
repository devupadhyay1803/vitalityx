...
export default function LandingPage() {
 ...
 <p className="mb-5 inline-flex items-center gap-2 rounded-full vx-card px-3 py-1 text-xs uppercase tracking-widest text-muted-foreground">
 ...
 <div key={title} className="vx-card p-6 transition hover:shadow-md">
 ...
 {STEPS.map((s) => (
 <div key={s.n} className="relative vx-card p-6">
